...
public class CSV {
    public static void makeCSV(double[] var, MyNode[] pu, MyNode[] pro, MyEdge[] edges, int N, double sw,
        ...
        // FileWriter fw = new FileWriter("/home/imahori/NetBeansProjects/P2P_maximin/test/p2pmaximin_time" + (it) + "_.csv", false);  //※１
        FileWriter fw = new FileWriter("/home/imahori/NetBeansProjects/results/p2pmaximin_time" + (it) + "_.csv", false); 
