 ...
 */
package p2p_maximin; // Prosumers' Benefit Maximin Problem
...
// solver return
    ...
    public static void main(String[] args) throws IOException {
        ...
        for(int it = 0; it < ite; it++){
            ...
            while(c < N){
               // System.out.println("set parameters");
                ...
                for(int b = 0; b < N; b++){
                    ...
                    //double rand_geValue = rand_ge.nextGaussian();
                    ////ge_val = rand_geValue;
                    //System.out.println(">>>>>>>>>>>>>>>>>> ge_val : " + ge_val);
            ...
            // ---------------------- Solver --------------------------------------
            array = Solver_maximin.milp(pu, pro, edges, total_sw, total_disp, total_std, total_per, total_disp_per, total_std_per, it, N, counter);
            ...
            if(sw_counter == 1){
                for(int u = 0; u < N; u++){
                    pro[u].total_max_benefit = pro[u].total_max_benefit - pro[u].max_uti;
                }
            }
            //System.out.println("counter ++++++++++++++++++ : " + counter);
            
        } // last iteration
        //DayCSV.dayCSV(pu, pro, N, total_sw, total_std, total_disp, total_per, total_std_per, total_disp_per, ite, counter);
