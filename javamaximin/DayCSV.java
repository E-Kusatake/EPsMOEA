...
public class DayCSV {
    public static void dayCSV(MyNode[] pu, MyNode[] pro, int N, double sw, double std, double disp,
            double total_per, double total_std_per, double total_disp_per, int it, double counter) throws IOException{
        //出力先を作成する
        //System.out.println("CSV");
        // FileWriter fw = new FileWriter("/home/imahori/NetBeansProjects/P2P_maximin/test/p2pmaximin_fin.csv", false);  //※１
        FileWriter fw = new FileWriter("/home/imahori/NetBeansProjects/results/p2pmaximin_fin.csv", false);
        ...
        ave_disp_per = total_disp_per/counter;
        ...
        ave_std_per = total_std_per/counter;
